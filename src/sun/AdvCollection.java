...
public class AdvCollection {
    public static void main(String[] args) {
       ...
       /* for(int i=0; i<names.size(); ++i) {
            if (names.get(i).name.equals("디아블로")) { }
        } // HashSet에서는 get사용불가*/
        ...
        */
        ...
        for(Integer key5 : keys2){
            System.out.println(games.get(key5).name);
            System.out.println(games.get(key5).price);
        }
        ...
        //cpu연산이 많이 필요하지 않음.
        //같은 입력값에 대해서는 같은 결과가 출력
        //단 해시함수 알고리즘에 따라 다르게 출력가능
        //간혹, 서로 다른 데이터에 대해 같은 결고 값이 나오는 경우
        // "충돌" 발생
