...
/*객체지향 프로그래밍 개요
* 현실의 모든사물을 객체로 취급하여 소프트웨어를 개발하는 방식
* 객체 : 실생활에서 우리가 인식하는 유/무형의 사물
* ex)집, 자동차, 사람, 급여, 주문,...
*
* 클래스 : 객체를 만들어 내기 위한 틀, 설계도
* 클래스에는 객체의 상태를 나타내는 필드/속성과 객체의 기능을
* 나타내는 메서드로 구성됨
*
* 클래스는 객체의 설계도이기 때문에 실제 정보는 저장 할 수 없음
* 실제정보를 저장하려면, 이것의 객체가 필요한데 객체를 선언하는 과정을
* 객체화(instanate)라고 함
...
public class OOP {
    ...
    public static void main(String[] args) {
        ...
        * 클래스명 객체명 = new 생성자;*/
        ...
        Person cho = new Person("순열", "학생", 32, "남", "A");
